...
session_start();
require_once DBUtils::PATH . '/vendor/connection.php';
require_once DBUtils::PATH . '/assets/classes/UserProfile.class.php';
require_once DBUtils::PATH . '/assets/classes/UserRegistration.class.php';
